...
MRESULT AeMgr::cameraPreviewReinit()
{
    ...
    if(m_eAECamMode != LIB3A_AECAM_MODE_VIDEO) {
        ...
        MY_LOG("[cameraPreviewReinit] Restore m_eAECamMode:%d Real ISO:%d Exp mode: %d, Shutter:%d Sensor gain:%d Isp gain:%d frame rate:%d flare:%d %d ISO:%d\n",
...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MRESULT AeMgr::doPvAE(MINT32 i4FrameCount, MVOID *pAEStatBuf)
{
strAEInput rAEInput;
strAEOutput rAEOutput;
