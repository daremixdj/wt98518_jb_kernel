...
class AudioAnalogType
{
    public:
        ...
        enum VOLUME_TYPE
        {
            ...
            VOLUME_LEVELSHIFTL,
            VOLUME_LEVELSHIFTR,
            VOLUME_VOICECALL_SPKL,
            VOLUME_VOICECALL_SPKR,
            VOLUME_VOICECALL_HPOUTL,
            VOLUME_VOICECALL_HPOUTR,
            VOLUME_IN_MIC1L,
            VOLUME_IN_MIC1R,
            VOLUME_IN_MIC2L,
            VOLUME_IN_MIC2R,
            VOLUME_IN_HPMICL,
            VOLUME_IN_HPMICR,
            VOLUME_DUALMODE_OUTL,
            VOLUME_DUALMODE_OUTR,
            VOLUME_IN_FACTORY_MAIN_MIC,
            VOLUME_IN_FACTORY_REF_MIC,
            VOLUME_TYPE_MAX
        };
