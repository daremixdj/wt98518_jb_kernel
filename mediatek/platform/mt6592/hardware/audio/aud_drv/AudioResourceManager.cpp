...
status_t AudioResourceManager::TurnonAudioDevice(unsigned int mDlOutputDevice)
{
    ...
    if (DeviceCount == 1)
    {
        ...
        {
#ifdef MTK_AUDIO_EXTCODEC_SUPPORT //Qlw 2013/11/05
#ifdef HP_USING_EXTDAC
            mAudioAnalogExtInstance->AnalogOpen(AudioAnalogType::DEVICE_OUT_EARPIECER, AudioAnalogType::DEVICE_PLATFORM_MACHINE);
#endif
#else
        ...
        if (mDlOutputDevice & AUDIO_DEVICE_OUT_SPEAKER)
        {
            ...
            tfa9887_SpeakerOn();
#else
#ifdef MTK_AUDIO_EXTCODEC_SUPPORT //Qlw 2013/10/28
#ifdef HP_USING_EXTDAC
            mAudioAnalogExtInstance->AnalogOpen(AudioAnalogType::DEVICE_OUT_SPEAKERR, AudioAnalogType::DEVICE_PLATFORM_MACHINE);
#endif
#else
...
status_t AudioResourceManager::TurnonAudioDeviceIncall(unsigned int mDlOutputDevice)
{
    ...
    if (DeviceCount == 1)
    {
        if (mDlOutputDevice & AUDIO_DEVICE_OUT_EARPIECE)
        {
            ...
            mAudioAnalogInstance->AnalogSetMux(AudioAnalogType::DEVICE_OUT_EARPIECER , AudioAnalogType::MUX_VOICE);
#ifdef MTK_AUDIO_EXTCODEC_SUPPORT //Qlw 2013/11/06
#ifdef HP_USING_EXTDAC
            mAudioAnalogExtInstance->AnalogOpen(AudioAnalogType::DEVICE_OUT_EARPIECER, AudioAnalogType::DEVICE_PLATFORM_MACHINE);
#endif
#else
...
status_t AudioResourceManager::TurnoffAudioDevice(unsigned int mDlOutputDevice)
{
    ...
    if (DeviceCount == 1)
    {
        if (mDlOutputDevice & AUDIO_DEVICE_OUT_EARPIECE)
        {
#ifdef MTK_AUDIO_EXTCODEC_SUPPORT //Qlw 2013/11/04
#ifdef HP_USING_EXTDAC
...
#ifdef MTK_AUDIO_EXTCODEC_SUPPORT //Qlw 2013/10/28
#ifdef HP_USING_EXTDAC
            mAudioAnalogExtInstance->AnalogClose(AudioAnalogType::DEVICE_OUT_SPEAKERR, AudioAnalogType::DEVICE_PLATFORM_MACHINE);
#endif
#else
...
#ifdef MTK_AUDIO_EXTCODEC_SUPPORT //Qlw 2013/12/13
#ifdef HP_USING_EXTDAC
                if (mUlInputDevice == (AUDIO_DEVICE_IN_BUILTIN_MIC))
                {
                    mAudioAnalogExtInstance->SetAnalogGain(AudioAnalogType::VOLUME_IN_MIC1L, AudioAnalogType::DEVICE_PLATFORM_MACHINE);
                }
                else if (mUlInputDevice == (AUDIO_DEVICE_IN_WIRED_HEADSET))
                {
                    mAudioAnalogExtInstance->SetAnalogGain(AudioAnalogType::VOLUME_IN_HPMICL, AudioAnalogType::DEVICE_PLATFORM_MACHINE);
                }
#endif
#endif
            }
...
#ifdef MTK_AUDIO_EXTCODEC_SUPPORT //Qlw 2013/12/13
#ifdef HP_USING_EXTDAC
                uint32 DlDevice = getDlOutputDevice();
                ALOGD("getDlOutputDevice DlDevice =  0x%x", DlDevice);
                if (DlDevice == (AUDIO_DEVICE_OUT_SPEAKER))
                {
                    mAudioVolumeInstance->ApplyMicGain(Idle_Normal_Record , mAudioMode);
                    mAudioAnalogExtInstance->SetAnalogGain(AudioAnalogType::VOLUME_IN_MIC1L, AudioAnalogType::DEVICE_PLATFORM_MACHINE);
                }
                else if ((DlDevice == (AUDIO_DEVICE_OUT_WIRED_HEADSET))||(DlDevice == (AUDIO_DEVICE_OUT_WIRED_HEADPHONE)))
                {
...
#ifdef MTK_AUDIO_EXTCODEC_SUPPORT //Qlw 2013/11/05
#ifdef HP_USING_EXTDAC
        mAudioAnalogExtInstance->AnalogClose(AudioAnalogType::DEVICE_IN_ADC1, AudioAnalogType::DEVICE_PLATFORM_MACHINE);
#endif
#endif
    }
    else if (mUlInputDevice  == AUDIO_DEVICE_IN_BLUETOOTH_SCO_HEADSET)
