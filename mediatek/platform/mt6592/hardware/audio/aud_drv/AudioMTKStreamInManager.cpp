            ...
            switch (Client->mSourceType)
            {
                ...
                case AudioDigitalType::I2S_IN_2:
...
#ifdef MTK_AUDIO_EXTCODEC_SUPPORT //Qlw 2013/11/05
                    {
                        ...
                        memset((void *)&m2ndI2SOutAttribute, 0, sizeof(m2ndI2SOutAttribute));
                        
                        m2ndI2SOutAttribute.mLR_SWAP = AudioDigtalI2S::NO_SWAP;
                        m2ndI2SOutAttribute.mI2S_IN_PAD_SEL = AudioDigtalI2S::I2S_IN_FROM_IO_MUX;
                        m2ndI2SOutAttribute.mI2S_SLAVE = AudioDigtalI2S::MASTER_MODE; // TODO: DEFAULT MASTER MODE ???
                        m2ndI2SOutAttribute.mI2S_SAMPLERATE = Client->mAttributeClient->mSampleRate;
                        m2ndI2SOutAttribute.mINV_LRCK = AudioDigtalI2S::NO_INVERSE;
                        m2ndI2SOutAttribute.mI2S_FMT = AudioDigtalI2S::I2S;
                        m2ndI2SOutAttribute.mI2S_WLEN = AudioDigtalI2S::WLEN_16BITS;

                        mAudioDigital->Set2ndI2SOutAttribute (m2ndI2SOutAttribute.mI2S_SAMPLERATE);
                        mAudioDigital->Set2ndI2SOut(&m2ndI2SOutAttribute);
                        mAudioDigital->Set2ndI2SOutEnable(true);
                    }
#endif
                    }
                    break;
