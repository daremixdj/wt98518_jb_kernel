...
status_t AudioLoopbackController::OpenAudioLoopbackControlFlow(const audio_devices_t input_device, const audio_devices_t output_device, uint32 ul_samplerate, uint32 dl_samplerate)
{
    ...
    {
#ifdef MTK_AUDIO_EXTCODEC_SUPPORT //Qlw 2013/12/30
#ifdef HP_USING_EXTDAC
        mAudioDigitalInstance->SetinputConnection(AudioDigitalType::Connection, AudioDigitalType::I00, AudioDigitalType::O00); // I2S_IN_2_L -> I2S_OUT_2_L
        mAudioDigitalInstance->SetinputConnection(AudioDigitalType::Connection, AudioDigitalType::I01, AudioDigitalType::O01); // I2S_IN_2_L -> I2S_OUT_2_R

        Set2ndI2sInAttribute(16000);
        Set2ndI2sOutAttribute(16000);
...
#endif
#ifdef MTK_AUDIO_EXTCODEC_SUPPORT //Qlw 2013/11/18
#ifdef HP_USING_EXTDAC
    if (output_device == AUDIO_DEVICE_OUT_SPEAKER)
    {
        mAudioAnalogExtInstance->SetAnalogGain(AudioAnalogType::VOLUME_VOICECALL_SPKL, 7);
    }
    else if (output_device == AUDIO_DEVICE_OUT_EARPIECE)
    {
        mAudioAnalogExtInstance->SetAnalogGain(AudioAnalogType::VOLUME_HSOUTL, 7);
    }
    else
    {
        mAudioAnalogExtInstance->SetAnalogGain(AudioAnalogType::VOLUME_VOICECALL_HPOUTL, 7);
    }
#endif
#endif
...
status_t AudioLoopbackController::CloseAudioLoopbackControlFlow()
{
    ...
    else
    {
        ...
        mAudioDigitalInstance->SetinputConnection(AudioDigitalType::DisConnect, AudioDigitalType::I00, AudioDigitalType::O00); // I2S_IN_2_L -> I2S_OUT_2_L
        mAudioDigitalInstance->SetinputConnection(AudioDigitalType::DisConnect, AudioDigitalType::I01, AudioDigitalType::O01); // I2S_IN_2_L -> I2S_OUT_2_R
#endif
#else
...
#ifdef MTK_AUDIO_EXTCODEC_SUPPORT //Qlw 2013/11/18
#ifdef HP_USING_EXTDAC
    mAudioAnalogExtInstance->AnalogClose(AudioAnalogType::DEVICE_OUT_EARPIECER, AudioAnalogType::DEVICE_PLATFORM_MACHINE);
#endif
#endif
...
status_t AudioLoopbackController::Set2ndI2sOutAttribute(int sample_rate)
{
    AudioDigtalI2S i2s_2_out_attribute;
    memset((void *)& i2s_2_out_attribute, 0, sizeof(i2s_2_out_attribute));

    i2s_2_out_attribute.mLR_SWAP = AudioDigtalI2S::NO_SWAP;
    i2s_2_out_attribute.mI2S_SAMPLERATE = sample_rate;
    i2s_2_out_attribute.mINV_LRCK = AudioDigtalI2S::NO_INVERSE;
    i2s_2_out_attribute.mI2S_FMT = AudioDigtalI2S::I2S;
#if 1
    i2s_2_out_attribute.mI2S_WLEN = AudioDigtalI2S::WLEN_16BITS;
#else
    i2s_2_out_attribute.mI2S_WLEN = AudioDigtalI2S::WLEN_32BITS;
    i2s_2_out_attribute.mI2S_HD_EN = AudioDigtalI2S::LOW_JITTER_CLOCK;
#endif
    mAudioDigitalInstance->Set2ndI2SOut (&i2s_2_out_attribute);
    return NO_ERROR;
}

status_t AudioLoopbackController::Set2ndI2sInAttribute(int sample_rate)
{
    AudioDigtalI2S i2s_2_in_attribute;
    memset((void *)& i2s_2_in_attribute, 0, sizeof(i2s_2_in_attribute));

    i2s_2_in_attribute.mLR_SWAP = AudioDigtalI2S::NO_SWAP;
    i2s_2_in_attribute.mBuffer_Update_word = 8;
    i2s_2_in_attribute.mFpga_bit_test = 0;
    i2s_2_in_attribute.mFpga_bit = 0;
    i2s_2_in_attribute.mloopback = 0;
    i2s_2_in_attribute.mINV_LRCK = AudioDigtalI2S::NO_INVERSE;
    i2s_2_in_attribute.mI2S_FMT = AudioDigtalI2S::I2S;
    i2s_2_in_attribute.mI2S_WLEN = AudioDigtalI2S::WLEN_16BITS;
    i2s_2_in_attribute.mI2S_SAMPLERATE = sample_rate;
    i2s_2_in_attribute.mI2S_EN = false;
#ifdef MTK_AUDIO_EXTCODEC_SUPPORT //Qlw 2013/11/18
#ifdef HP_USING_EXTDAC
    i2s_2_in_attribute.mI2S_IN_PAD_SEL = true;
#endif
#endif
    mAudioDigitalInstance->Set2ndI2SIn (&i2s_2_in_attribute);
    return NO_ERROR;
}
