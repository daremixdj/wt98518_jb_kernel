...
status_t AudioAnalogControlExt::SetAnalogGain(AudioAnalogType::VOLUME_TYPE VoleumType, int volume)
{
    ...
    switch (VoleumType)
    {
...
#ifdef HP_USING_EXTDAC //Qlw 2013/11/04
            ::ioctl(mFd, SET_EXTCODEC_VOICECALL_EARPIECE_OUT, NULL);
#endif
            break;
        case AudioAnalogType::VOLUME_HPOUTL:
        case AudioAnalogType::VOLUME_HPOUTR:
#ifdef HP_USING_EXTDAC //Qlw 2013/11/12
...
#ifdef HP_USING_EXTDAC //Qlw 2013/11/04
            ::ioctl(mFd, SET_EXTCODEC_MUSIC_SPEAKER_OUT, NULL);
#endif
            break;
        ...
        case AudioAnalogType::VOLUME_IV_BUFFER:
            break;
        case AudioAnalogType::VOLUME_VOICECALL_SPKL:
        case AudioAnalogType::VOLUME_VOICECALL_SPKR:
#ifdef HP_USING_EXTDAC //Qlw 2013/11/04
            ::ioctl(mFd, SET_EXTCODEC_VOICECALL_SPEAKER_OUT, NULL);
#endif
            break;
        case AudioAnalogType::VOLUME_VOICECALL_HPOUTL:
        case AudioAnalogType::VOLUME_VOICECALL_HPOUTR:
#ifdef HP_USING_EXTDAC //Qlw 2013/11/04
            ::ioctl(mFd, SET_EXTCODEC_VOICECALL_HEADPHONE_OUT, NULL);
#endif
            break;
        case AudioAnalogType::VOLUME_IN_MIC1L:
        case AudioAnalogType::VOLUME_IN_MIC1R:
#ifdef HP_USING_EXTDAC //Qlw 2013/11/05
            ::ioctl(mFd, SET_EXTCODEC_MIC1_IN, NULL);
#endif
            break;
        case AudioAnalogType::VOLUME_IN_MIC2L:
        case AudioAnalogType::VOLUME_IN_MIC2R:
#ifdef HP_USING_EXTDAC //Qlw 2013/11/05
            ::ioctl(mFd, SET_EXTCODEC_MIC2_IN, NULL);
#endif
            break;
        case AudioAnalogType::VOLUME_IN_HPMICL:
        case AudioAnalogType::VOLUME_IN_HPMICR:
#ifdef HP_USING_EXTDAC //Qlw 2013/11/05
            ::ioctl(mFd, SET_EXTCODEC_HPMIC_IN, NULL);
#endif
            break;
        case AudioAnalogType::VOLUME_DUALMODE_OUTL:
        case AudioAnalogType::VOLUME_DUALMODE_OUTR:
#ifdef HP_USING_EXTDAC //Qlw 2013/12/16
            ::ioctl(mFd, SET_EXTCODEC_DUALMODE_OUT, NULL);
#endif
            break;
        case AudioAnalogType::VOLUME_IN_FACTORY_MAIN_MIC:
#ifdef HP_USING_EXTDAC //Qlw 2013/12/20
            ::ioctl(mFd, SET_EXTCODEC_FACTORY_MAIN_MIC, volume);
#endif
            break;
        case AudioAnalogType::VOLUME_IN_FACTORY_REF_MIC:
#ifdef HP_USING_EXTDAC //Qlw 2013/12/20
            ::ioctl(mFd, SET_EXTCODEC_FACTORY_REF_MIC, volume);
#endif
            break;
...
status_t AudioAnalogControlExt::AnalogClose(AudioAnalogType::DEVICE_TYPE DeviceType, AudioAnalogType::DEVICE_TYPE_SETTING Type_setting)
{
    ...
    switch (DeviceType)
    {
        ...
        case AudioAnalogType::DEVICE_OUT_EARPIECEL:
#ifdef HP_USING_EXTDAC //Qlw 2013/11/04
            ::ioctl(mFd, SET_EXTCODEC_OFF, AudioAnalogType::DEVICE_OUT_EARPIECEL);
#endif
            break;
        ...
        case AudioAnalogType::DEVICE_OUT_HEADSETL:
            ...
            ::ioctl(mFd, SET_EXTHEADPHONE_AMP_OFF, NULL);
            ::ioctl(mFd, SET_EXTCODEC_OFF, AudioAnalogType::DEVICE_OUT_HEADSETL);
#endif
            break;

        case AudioAnalogType::DEVICE_OUT_SPEAKERR:
        case AudioAnalogType::DEVICE_OUT_SPEAKERL:
#ifdef HP_USING_EXTDAC //Qlw 2013/11/01
            ::ioctl(mFd, SET_EXTCODEC_OFF, AudioAnalogType::DEVICE_OUT_SPEAKERL);
#endif
        break;
        ...
        case AudioAnalogType::DEVICE_IN_ADC1:
        case AudioAnalogType::DEVICE_IN_ADC2:
#ifdef HP_USING_EXTDAC //Qlw 2013/12/12
            ::ioctl(mFd, SET_EXTCODEC_OFF, AudioAnalogType::DEVICE_IN_ADC1);
#endif
            break;
        case AudioAnalogType::DEVICE_IN_DIGITAL_MIC:
            break;
