...
status_t AudioDigitalControl::Set2ndI2SOut(AudioDigtalI2S *mDigitalI2S)
{
    ALOGD("+%s()\n", __FUNCTION__);
#ifdef MTK_AUDIO_EXTCODEC_SUPPORT
    //mAfeReg->SetAfeReg(AUDIO_TOP_CON1, 0x2, 0x2); //Qlw 2013/11/01
#endif
...
#ifdef MTK_AUDIO_EXTCODEC_SUPPORT
    //mAfeReg->SetAfeReg(AUDIO_TOP_CON1, 0x0, 0x2); //Qlw 2013/11/01
#endif
    return NO_ERROR;
}
...
return AudioDigitalType::I2S_OUT_DAC;
    ...
    {
#ifdef MTK_AUDIO_EXTCODEC_SUPPORT //Qlw 2013/10/26
        return AudioDigitalType::I2S_OUT_2;
#else
        return AudioDigitalType::I2S_OUT_DAC;
#endif
