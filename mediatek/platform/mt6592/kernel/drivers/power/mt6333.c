...
/*add by pengjinqiang begin for  imx134  i2c  affecting the pmic 6333*/	
#ifdef WT_93950_MT6333_SUPPORT
	pmic_ldo_vol_sel(MT6323_POWER_LDO_VCAM_IO, VOL_1800);
	pmic_ldo_enable(MT6323_POWER_LDO_VCAM_IO, KAL_TRUE);
#endif
