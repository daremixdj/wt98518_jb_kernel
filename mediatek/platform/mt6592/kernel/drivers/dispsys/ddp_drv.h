...
#define DISP_IOCTL_GET_GAMMAPARAM_FROM_LCDDRV  _IOR  (DISP_IOCTL_MAGIC, 61 , DISP_PQ_PARAM)
#define DISP_IOCTL_GET_PQPARAM_FROM_LCDDRV  _IOR  (DISP_IOCTL_MAGIC, 62 , DISP_PQ_PARAM)
#endif
