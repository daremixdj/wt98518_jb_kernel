...
//Qlw 2013/11/02
#define SET_EXTCODEC_VOICECALL_EARPIECE_OUT    _IOW(AUD_DRV_IOC_MAGIC, 0xb1, int)
#define SET_EXTCODEC_VOICECALL_HEADPHONE_OUT    _IOW(AUD_DRV_IOC_MAGIC, 0xb2, int)
#define SET_EXTCODEC_VOICECALL_SPEAKER_OUT    _IOW(AUD_DRV_IOC_MAGIC, 0xb3, int)
#define SET_EXTCODEC_MUSIC_SPEAKER_OUT    _IOW(AUD_DRV_IOC_MAGIC, 0xb4, int)
#define SET_EXTCODEC_MIC1_IN    _IOW(AUD_DRV_IOC_MAGIC, 0xb5, int)
#define SET_EXTCODEC_MIC2_IN    _IOW(AUD_DRV_IOC_MAGIC, 0xb6, int)
#define SET_EXTCODEC_HPMIC_IN    _IOW(AUD_DRV_IOC_MAGIC, 0xb7, int)
#define FM36_DENOISE_ENABLE    _IOW(AUD_DRV_IOC_MAGIC, 0xb8, int)
#define FM36_DENOISE_DISABLE    _IOW(AUD_DRV_IOC_MAGIC, 0xb9, int)
#define SET_EXTCODEC_DUALMODE_OUT    _IOW(AUD_DRV_IOC_MAGIC, 0xba, int)
#define SET_EXTCODEC_FACTORY_MAIN_MIC    _IOW(AUD_DRV_IOC_MAGIC, 0xbb, int)
#define SET_EXTCODEC_FACTORY_REF_MIC    _IOW(AUD_DRV_IOC_MAGIC, 0xbc, int)
