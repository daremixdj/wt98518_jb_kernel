...
struct excel_info PartInfo[PART_NUM]={
			...
			{"bootimg",16777216,0x1da0000, EMMC, 0,EMMC_PART_USER},
			{"recovery",16777216,0x2da0000, EMMC, 0,EMMC_PART_USER},
			{"sec_ro",6291456,0x3da0000, EMMC, 4,EMMC_PART_USER},
			{"misc",524288,0x43a0000, EMMC, 0,EMMC_PART_USER},
			{"logo",8388608,0x4420000, EMMC, 0,EMMC_PART_USER},
			{"ebr2",524288,0x4c20000, EMMC, 0,EMMC_PART_USER},
			{"blinkfeed",27262976,0x4ca0000, EMMC, 5,EMMC_PART_USER},
			{"rootm",4194304,0x66a0000, EMMC, 0,EMMC_PART_USER},
			{"expdb",14024704,0x6aa0000, EMMC, 0,EMMC_PART_USER},
			{"android",1300234240,0x7800000, EMMC, 6,EMMC_PART_USER},
			{"cache",218103808,0x55000000, EMMC, 7,EMMC_PART_USER},
			{"usrdata",1237319680,0x62000000, EMMC, 8,EMMC_PART_USER},
