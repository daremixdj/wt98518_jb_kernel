...
$(foreach m,$(CUSTOM_MODEM),\
	...
	$(eval d := mediatek/custom/common/modem/$(m)/modem_feature_$(m).mak)\
	$(if $(s),\
...
ifeq (yes, $(strip $(MTK_GEMINI_3G_SWITCH)))
  ifeq (yes, $(strip $(MTK_DT_3G_SWITCH)))
    $(call dep-err-offa-or-offb, MTK_DT_3G_SWITCH, MTK_GEMINI_3G_SWITCH)
  endif
  ...
  ifeq (yes, $(strip $(MTK_DT_3G_SWITCH)))
    ifneq (yes, $(strip $(MTK_DT_SUPPORT)))
      $(call dep-err-ona-or-offb, MTK_DT_SUPPORT, MTK_DT_3G_SWITCH)
    endif
    ifeq (0, $(strip $(MTK_GEMINI_SMART_3G_SWITCH)))
      $(call dep-err-seta-or-offb, MTK_GEMINI_SMART_3G_SWITCH,>=1, MTK_DT_3G_SWITCH)
    endif
  else
    ifneq (0, $(strip $(MTK_GEMINI_SMART_3G_SWITCH)))
      $(call dep-err-seta-or-onb, MTK_GEMINI_SMART_3G_SWITCH,0, MTK_GEMINI_3G_SWITCH or MTK_DT_3G_SWITCH)
    endif
  endif
endif
...
ifeq ($(filter zh_CN,$(MTK_PRODUCT_LOCALES)),)
  ...
  ifeq (yes,$(strip $(MTK_BAIDU_MAP_SUPPORT)))
    $(call dep-err-common, pelase add zh_CN in MTK_PRODUCT_LOCALES or turn off MTK_BAIDU_MAP_SUPPORT)
  endif
  ifeq (yes,$(strip $(MTK_BAIDU_SEARCH_BAR_SUPPORT)))
    $(call dep-err-common, pelase add zh_CN in MTK_PRODUCT_LOCALES or turn off MTK_BAIDU_SEARCH_BAR_SUPPORT)
  endif
  ...
  ifeq (yes, $(strip $(MTK_BAIDU_LOCATION_SUPPORT)))
    $(call dep-err-common, pelase add zh_CN in MTK_PRODUCT_LOCALES or turn off MTK_BAIDU_LOCATION_SUPPORT)
  endif
endif
...
ifeq (OP01_SPEC0200_SEGC, $(strip $(OPTR_SPEC_SEG_DEF)))
   ...
   ifneq ($(MTK_TODOS_APP),yes)
      $(call dep-err-common, Please turn on MTK_TODOS_APP or set OPTR_SPEC_SEG_DEF as not OP01_SPEC0200_SEGC)
   endif
...
ifeq ($(MTK_INTERNAL), yes)
   ...
   ifeq ($(MTK_BAIDU_LOCATION_SUPPORT),yes)
      $(call dep-err-common, Please turn off MTK_BAIDU_LOCATION_SUPPORT or set OPTR_SPEC_SEG_DEF as not OP01_SPEC0200_SEGC When MTK_INTERNAL set as yes)
   endif
   ifeq ($(MTK_BAIDU_SEARCH_BAR_SUPPORT),yes)
      $(call dep-err-common, Please turn off MTK_BAIDU_SEARCH_BAR_SUPPORT or set OPTR_SPEC_SEG_DEF as not OP01_SPEC0200_SEGC When MTK_INTERNAL set as yes)
   endif
endif
endif
...
ifneq (yes,$(strip $(MTK_GPU_SUPPORT)))
  ifeq (yes,$(strip $(MTK_NATIVE_FENCE_SUPPORT)))
    $(call dep-err-ona-or-offb,MTK_GPU_SUPPORT,MTK_NATIVE_FENCE_SUPPORT)
  endif
  ifeq (yes,$(strip $(MTK_HWC_SUPPORT)))
    $(call dep-err-ona-or-offb,MTK_GPU_SUPPORT,MTK_HWC_SUPPORT)
  endif
  ifeq (yes,$(strip $(MTK_HWUI_SUPPORT)))
    $(call dep-err-ona-or-offb,MTK_GPU_SUPPORT,MTK_HWUI_SUPPORT)
  endif
endif
##################################################################
...
ifneq (yes,$(strip $(MTK_VOICE_UI_SUPPORT)))
  ifeq (yes,$(strip $(MTK_VOICE_CONTACT_SEARCH_SUPPORT)))
    $(call dep-err-ona-or-offb,MTK_VOICE_UI_SUPPORT,MTK_VOICE_CONTACT_SEARCH_SUPPORT)
  endif
endif

ifneq (yes,$(strip $(MTK_CLEARMOTION_SUPPORT)))
  ifeq (yes,$(strip $(MTK_EPC_CLEARMOTION_CUSTOM_SUPPORT)))
    $(call dep-err-ona-or-offb,MTK_CLEARMOTION_SUPPORTT,MTK_EPC_CLEARMOTION_CUSTOM_SUPPORT)
  endif
endif
