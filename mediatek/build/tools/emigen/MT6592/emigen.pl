...
if ($os eq "windows")
{
    ...
    $CUSTOM_EMI_C_LK =~ s/custom_MemoryDevice.h$/output\\custom_emi\.c/i;#wangfuqiang 
...
elsif ($os eq "linux")
{
    ...
    $CUSTOM_EMI_C_LK =~ s/preloader\/inc\/custom_MemoryDevice.h$/lk\/custom_emi\.c/i;#wangfuqiang 
