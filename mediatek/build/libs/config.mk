...
$(eval include $(MTK_ROOT_CONFIG)/common/autoconfig/$(2)/config.mk) \
$(eval _merge_order_ := $(call wildcard2,$(foreach m,$(merge-order),$(foreach p,\
  $(call reverse,$(MTK_CUSTOM_FOLDERS)),$(MTK_ROOT_CONFIG)/$(p)/autoconfig/$(2)/$(m))))) \
$(eval _target_file_ := $(MTK_ROOT_GEN_CONFIG)/$(2)) \
...
$(if $(filter yes, $(strip $(BUILD_KERNEL))), \
     $(foreach c,$(MTK_AUTOCONFIG_LIST),$(call .mtk.config.generate-auto-rules,$(1),$(c))), \
) \
