...
public final class Utils {
    ...
    public static ArrayList<Uri> getUrisFromBucketId(Context context,
        ...
        try {
            ...
            //        + bucketId;
            // For filter 4k video
            String where = MediaStore.Video.VideoColumns.BUCKET_ID + "=" + bucketId + " AND (("
                    + MediaStore.Video.VideoColumns.WIDTH + " <= 1920" + " AND " + MediaStore.Video.VideoColumns.HEIGHT
                    + " <= 1920)" + " OR (" + MediaStore.Video.VideoColumns.WIDTH + " IS NULL"
                    + " OR " + MediaStore.Video.VideoColumns.HEIGHT + " IS NULL))";
