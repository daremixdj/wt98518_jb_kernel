...
//        initService(iCurrentStation);
    ...
    private final OnAudioFocusChangeListener mAudioFocusChangeListener = new OnAudioFocusChangeListener() {
        ...
        public void onAudioFocusChange(int focusChange) {
            ...
            case AudioManager.AUDIOFOCUS_LOSS_TRANSIENT_CAN_DUCK:
                synchronized (this) {
                    LogUtils.d(TAG, "AudioFocus: received AUDIOFOCUS_LOSS_TRANSIENT_CAN_DUCK");
                    stopFMFocusLoss(AudioManager.AUDIOFOCUS_LOSS_TRANSIENT_CAN_DUCK);
                }
                break;
            ///fsh:for 264044 @}
            default:
    ...
    private void updateAudioFocus(int focusState) { 
        ...
        switch (focusState) {
            ...
            case AudioManager.AUDIOFOCUS_LOSS_TRANSIENT :
            case AudioManager.AUDIOFOCUS_LOSS_TRANSIENT_CAN_DUCK :  ///fsh:for bug 264044
               if (mIsPowerUp) {
