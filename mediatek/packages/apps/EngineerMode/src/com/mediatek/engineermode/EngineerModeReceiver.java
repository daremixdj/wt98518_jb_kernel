...
public class EngineerModeReceiver extends BroadcastReceiver {
    ...
    // process *#*#13411#*#*
    private final Uri mEmUri = Uri.parse("android_secret_code://13411");
    ...
    public void onReceive(Context context, Intent intent) {
        if (intent.getAction().equals(
            ...
            }else if(uri.equals(Uri.parse("android_secret_code_*#_*#://9528"))){
            	Intent i = new Intent(context, com.mediatek.engineermode.networkselect.NetworkSelectActivity.class);
