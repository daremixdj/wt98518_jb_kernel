                    ...
                    if (phone != null) { 
                        ...
                        if (optr != null && "OP02".equals(optr)) {   
							...
							GeminiPhone mGeminiPhone = (GeminiPhone)PhoneFactory.getDefaultPhone();
							 ...
							 IccCardConstants.State  state = mGeminiPhone.getIccCardGemini(sim_id).getState();
                            ...
                            radio_on = checkSimRadioState(mContext, sim_id);
							 ...
							 // CatLog.d(LOGTAG, "StkAppService - SET_UP_MENU state[" + state + "]");
							 // CatLog.d(LOGTAG, "StkAppService - SET_UP_MENU IccCardConstants.State.PIN_REQUIRED[" + IccCardConstants.State.PIN_REQUIRED + "]");
							  //CatLog.d(LOGTAG, "StkAppService - SET_UP_MENU IccCardConstants.State.PUK_REQUIRED[" + IccCardConstants.State.PUK_REQUIRED + "]");
