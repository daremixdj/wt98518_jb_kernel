...
public class SmsRegReceiver extends BroadcastReceiver {
    ...
    public boolean enableAutoBoot(Context context) {
        //System.DEF_DM_BOOT_START_ENABLE_VALUE = 1;
        int value = System.getInt(context.getContentResolver(), System.DM_BOOT_START_ENABLE_KEY, SmsRegConst.DEF_DM_BOOT_START_ENABLE_VALUE);
