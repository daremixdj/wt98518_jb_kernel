...
public class FileManagerOperationActivity extends AbsBaseActivity implements
    ...
    protected class DetailInfoListener implements FileManagerService.OperationEventListener,
        ...
        public void onTaskProgress(ProgressInfo progressInfo) {
            ...
            if (mDetailsText == null) {
                Dialog dialog = ((AlertDialogFragment) getFragmentManager().
                        findFragmentByTag(DETAIL_DIALOG_TAG)).getDialog();
                if (dialog != null) {
                    mDetailsText = (TextView) dialog.findViewById(R.id.details_text);
                }
            }
            if (mDetailsText != null) {
                mStringBuilder.setLength(0);
        ...
        public void onTaskResult(int result) {
			...
			if (getFragmentManager() != null){
				//Bug271692, xiongwei.wt, ADD, 20140417, NullPointerException
				if (getFragmentManager().findFragmentByTag(DETAIL_DIALOG_TAG) != null) {
