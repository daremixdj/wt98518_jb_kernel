...
ALIVE_MAINSENSOR_STRUCT Alive_MainSensor;
EXPORT_SYMBOL(Alive_MainSensor);

/******************Create File For MainSensor_ID*************************/
static ssize_t store_MainSensor_ID(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    return size;
}
static ssize_t show_MainSensor_ID(struct device *dev,struct device_attribute *attr, char *buf)
{   
    return sprintf(buf, "0x%x\n", Alive_MainSensor.ID);
}
static DEVICE_ATTR(MainSensor_ID, 0664, show_MainSensor_ID, store_MainSensor_ID);
/*************************************************************/

/******************Create File For MainSensor_ModuleID*************************/
static ssize_t store_MainSensor_ModuleID(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
	return size;
}
static ssize_t show_MainSensor_ModuleID(struct device *dev,struct device_attribute *attr, char *buf)
{ 
	return sprintf(buf, "0x%x\n", Alive_MainSensor.ModuleID);
}
static DEVICE_ATTR(MainSensor_ModuleID, 0664, show_MainSensor_ModuleID, store_MainSensor_ModuleID);
/*************************************************************/

/******************Create File For MainSensor_VcmID*************************/
static ssize_t store_MainSensor_VcmID(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
	return size;
}
static ssize_t show_MainSensor_VcmID(struct device *dev,struct device_attribute *attr, char *buf)
{
	return sprintf(buf, "0x%x\n", Alive_MainSensor.VcmID);
}
static DEVICE_ATTR(MainSensor_VcmID, 0664, show_MainSensor_VcmID, store_MainSensor_VcmID);
/*************************************************************/
...
inline static int RegisterCAMERA_HWCharDrv(void)
{
	...
	device_create_file(sensor_device,&dev_attr_MainSensor_ID);
	device_create_file(sensor_device,&dev_attr_MainSensor_ModuleID);
	device_create_file(sensor_device,&dev_attr_MainSensor_VcmID);

	Alive_MainSensor.ID = 0xFFFFFFFF;
	Alive_MainSensor.ModuleID = 0xFFFFFFFF;
	Alive_MainSensor.VcmID = 0xFFFFFFFF;
