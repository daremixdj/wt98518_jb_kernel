...
#define	 MPU6880C_ACC_REG_CONFIG2	0x1D
#define  MPU6880C_ACC_REG_LP_ACCEL_ODR  0x1E

#define MPU6050C_ACC_REG_AUX_VDD         0x01
#define MPU6050C_ACC_REG_FIFO_EN         0x23 
...
#define  MPU6050C_ACC_REG_FIFO_CTL      0x6A    
#define  MPU6050C_ACC_REG_PWR_MGMT_1	0x6B
#define  MPU6050C_ACC_REG_PWR_MGMT_2	0x6C

#define MPU6050C_ACC_REG_FIFO_CNTH       0x72    
#define MPU6050C_ACC_REG_FIFO_CNTL       0x73    
#define MPU6050C_ACC_REG_FIFO_DATA       0x74    

#define MPU6050C_ACC_REG_DEVICE_ID	0x75	
#define MPU6050C_CHIP_ID	0x68
#define MPU6880_CHIP_ID		0x78
...
#define MPU6050C_ACC_FIFO_GYROX_EN       0x40	//insert the X Gyro data into FIFO
#define MPU6050C_ACC_FIFO_GYROY_EN       0x20	//insert the Y Gyro data into FIFO
#define MPU6050C_ACC_FIFO_GYROZ_EN       0x10	//insert the Z Gyro data into FIFO
...
#define MPU6050C_ACC_FIFO_EN			0x40	//enable FIFO operation for sensor data
#define MPU6050C_ACC_FIFO_RST			0x40    //reset FIFO function
