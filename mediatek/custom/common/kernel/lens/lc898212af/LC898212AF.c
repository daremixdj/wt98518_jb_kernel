...
extern int iReadCAM_CAL_A8(u16 a_u2Addr,u32 ui4_length,u8 *a_puBuff);
extern int iReadCAM_CAL_AA(u16 a_u2Addr,u32 ui4_length,u8 *a_puBuff);

u8 s4AF_EEPROM_Reg_ReadA8(u8 addr)

{
	u8 data;
	iReadCAM_CAL_A8(addr, 1, &data);
	return data;
}
u8 s4AF_EEPROM_Reg_ReadAA(u8 addr)
{
	u8 data;
	iReadCAM_CAL_AA(addr, 1, &data);
	return data;
}
...
static void readCalibrationData()
{
...
#else
	HallBiase=s4AF_EEPROM_Reg_ReadAA(0x04);
	s4LC898212AF_Reg_Write(0x29,HallBiase);
	LC898212AFDB("[LC898212AF] readCalibrationData:HallBiase =%x\n",HallBiase);


	HallOff=s4AF_EEPROM_Reg_ReadAA(0x03);
	s4LC898212AF_Reg_Write(0x28,HallOff);
	LC898212AFDB("[LC898212AF] readCalibrationData:HallOff =%x\n",HallOff);
...
#endif	
	eeprom_reg_read_data1=s4AF_EEPROM_Reg_ReadA8(0x0A);
	eeprom_reg_read_data2=s4AF_EEPROM_Reg_ReadA8(0x0B);
	g_release_inf=((eeprom_reg_read_data1<<8) | eeprom_reg_read_data2);
	...
	eeprom_reg_read_data1=s4AF_EEPROM_Reg_ReadAA(0x05/*0x06*//*0x02*/);
	eeprom_reg_read_data2=s4AF_EEPROM_Reg_ReadAA(0x06/*0x07*//*0x03*/);
	Hall_Max_Pos=(eeprom_reg_read_data1<<8) | eeprom_reg_read_data2;
	Hall_Max=0x7FFF;
	
	LC898212AFDB("[LC898212AF] readCalibrationData:Hall_Max_Pos =%x\n",Hall_Max_Pos);


	eeprom_reg_read_data1=s4AF_EEPROM_Reg_ReadAA(0x07/*0x08*//*0x04*/);
	eeprom_reg_read_data2=s4AF_EEPROM_Reg_ReadAA(0x08/*0x09*//*0x05*/);
	Hall_Min_Pos=(eeprom_reg_read_data1<<8) | eeprom_reg_read_data2;
	Hall_Min=0x8001;
...
inline static int moveLC898212AF(unsigned long a_u4Position)
{
    ...
    if (g_s4LC898212AF_Opened == 1)
    {
        ...
        ret = s4LC898212AF_ReadReg(&InitPos);
			    ram_read_data=s4LC898212AF_RAM_Read(0x3C);
	LC898212AFDB("[LC898212AF] moveLC898212AF (0x3C) =%x\n",ram_read_data);
	    ram_read_data=s4LC898212AF_RAM_Read(0x04);
	LC898212AFDB("[LC898212AF] moveLC898212AF (0x04) =%x\n",ram_read_data);
	    ram_read_data=s4LC898212AF_RAM_Read(0x02);
	LC898212AFDB("[LC898212AF] moveLC898212AF (0x02) =%x\n",ram_read_data);
       ram_read_data=s4LC898212AF_RAM_Read(0x18);
	LC898212AFDB("[LC898212AF] moveLC898212AF (0x18) =%x\n",data);
...
static int LC898212AF_Open(struct inode * a_pstInode, struct file * a_pstFile)
{
    ...
    LC898212AFDB("[LC898212AF] LC898212AF_Open -The version you download is correct--211-1000!!\n");
    ...
    ram_read_data=s4LC898212AF_RAM_Read(0x02);
    LC898212AFDB("[LC898212AF] s4LC898212AF_RAM_Read(0x02) 3=%x\n",ram_read_data);//Grant
    
    ram_read_data=s4LC898212AF_RAM_Read(0x04);
    LC898212AFDB("[LC898212AF] s4LC898212AF_RAM_Read(0x04) 3=%x\n",ram_read_data);
    
    ram_read_data=s4LC898212AF_RAM_Read(0x18);
    LC898212AFDB("[LC898212AF] s4LC898212AF_RAM_Read(0x18) 3=%x\n",ram_read_data);
    ...
    //mdelay(200);
    ram_read_data=s4LC898212AF_RAM_Read(0x3C);
    LC898212AFDB("[LC898212AF] s4LC898212AF_RAM_Read(0x3C) 4=%x\n",ram_read_data);
    ram_read_data=s4LC898212AF_RAM_Read(0x02);
    LC898212AFDB("[LC898212AF] s4LC898212AF_RAM_Read(0x02) 4=%x\n",ram_read_data);//Grant
    
    //StmvTo(ram_read_data);
    //StmvSet(StSmvPar);	

    ram_read_data=s4LC898212AF_RAM_Read(0x04);
    LC898212AFDB("[LC898212AF] s4LC898212AF_RAM_Read(0x04) 4=%x\n",ram_read_data);
    
    ram_read_data=s4LC898212AF_RAM_Read(0x18);
    LC898212AFDB("[LC898212AF] s4LC898212AF_RAM_Read(0x18) 4=%x\n",ram_read_data);
    
    ram_read_data=s4LC898212AF_RAM_Read(0x4C);
    LC898212AFDB("[LC898212AF] s4LC898212AF_RAM_Read(0x4C) 4=%x\n",ram_read_data);
    
    reg_read_data=s4LC898212AF_Reg_Read(0x4F);
    LC898212AFDB("[LC898212AF] s4LC898212AF_RAM_Read(0x4F) 4=%x\n",reg_read_data);
    ram_read_data=s4LC898212AF_RAM_Read(0x40);
    LC898212AFDB("[LC898212AF] s4LC898212AF_RAM_Read(0x40) 4=%x\n",ram_read_data);
    reg_read_data=s4LC898212AF_Reg_Read(0x83);
    LC898212AFDB("[LC898212AF] s4LC898212AF_RAM_Read(0x83) 4=%x\n",reg_read_data);
    ram_read_data=s4LC898212AF_RAM_Read(0x3C);
    
    LC898212AFDB("[LC898212AF] s4LC898212AF_RAM_Read(0x3C) 5=%x\n",ram_read_data);
    i=0;
