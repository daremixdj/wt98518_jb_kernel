...
{0x39, 0xBA,  16 ,{0x13, 0x82, 0x00, 0x16, 
				...
				0x0f, 0x24, 0x03, 0x21, 
				0x24, 0x25, 0x20, 0x08}},
{0x39, 0xB1,  16 ,{0x01, 0x00, 0x04, 0x87, 
				0x01, 0x11, 0x11, 0x35, 
				0x3d, 0x29, 0x29, 0x47, 
				0x02, 0x01, 0xE6,0xe2}},
{0x39, 0xB2,  6 ,{0x00, 0xc8, 0x09, 0x00,0x00, 0x33}},
...
{0x15, 0xB6,  1 ,{0x0b}},	
{0x39, 0xD5,  54 ,{0x00, 0x00, 0x00, 0x00, 
				0x0A, 0x00, 0x01, 0x00, 
				0xcc, 0x00, 0x00, 0x00, 
				0x88, 0x88, 0x88, 0x88, 
				0x99, 0x88, 0x88, 0x88, 
...
{0x39, 0xE0,  42 ,{0x00, 0x05, 0x11, 0x2d, 
				0x33, 0x3f, 0x19, 0x39, 
				0x05, 0x09, 0x10, 0x13, 
				0x15, 0x113, 0x15, 0x11, 
				0x18, 0x00, 0x05, 0x11,  
				0x2d, 0x33, 0x3f, 0x19, 
				0x39, 0x05, 0x09, 0x10, 
				0x13, 0x15, 0x13, 0x15, 
...
static void lcm_init(void)
{
		...
		SET_RESET_PIN(1);
		MDELAY(120); 	
		//mt_set_gpio_mode(GPIO14,0);
		//mt_set_gpio_dir(GPIO14,1);
		//mt_set_gpio_pull_enable(GPIO14,0);
		//mt_set_gpio_out(GPIO14,1);
