...
{
    ECODEC_PRINTK("ExtCodec_Set_Voicecall_Speaker_Out, factory main_mic:%d,ref_mic:%d,voicecall_speaker_out:%d\n",
        factory_mic.main_mic,factory_mic.ref_mic,wm5102_con.voicecall_speaker_out);
