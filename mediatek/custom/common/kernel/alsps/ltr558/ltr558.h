...
#define MODE_ALS_ON_Range1	0x0B //0x0B
#define MODE_ALS_ON_Range2	0x03 //0x03
...
#define ltr558_SUCCESS						0
#define ltr558_ERR_I2C						-1
#define ltr558_ERR_STATUS					-3
#define ltr558_ERR_SETUP_FAILURE			-4
#define ltr558_ERR_GETGSENSORDATA			-5
#define ltr558_ERR_IDENTIFICATION			-6
