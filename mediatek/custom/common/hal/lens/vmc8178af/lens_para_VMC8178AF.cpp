...
const NVRAM_LENS_PARA_STRUCT VMC8178AF_LENS_PARA_DEFAULT_VALUE =
{
    //Version
...
UINT32 VMC8178AF_getDefaultData(VOID *pDataBuf, UINT32 size)
{
    ...
    memcpy(pDataBuf, &VMC8178AF_LENS_PARA_DEFAULT_VALUE, dataSize);

    return 0;
}

PFUNC_GETLENSDEFAULT pVMC8178AF_getDefaultData = VMC8178AF_getDefaultData;
