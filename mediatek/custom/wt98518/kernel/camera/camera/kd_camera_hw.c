...
u32 pinSet[2][8] = {
	...
	else
    {
...
#if 1 //main-dvdd conncet to VGP3 and ov8825 use internal LDO
		...
		{
			//PK_DBG("kdCISModulePower--off get in---SENSOR_DRVNAME_NT99252_YUV \n");
		...
		{
			//PK_DBG("kdCISModulePower--off get in---SENSOR_DRVNAME_HI257_YUV \n");
