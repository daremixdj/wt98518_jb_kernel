...
#if defined(FM50AF_OV8858)
extern PFUNC_GETLENSDEFAULT pFM50AF_ov8858_getDefaultData;
#endif
...
#if defined(VMC8178AF)
extern PFUNC_GETLENSDEFAULT pVMC8178AF_getDefaultData;
#endif
#if defined(BU6424AF)
...
#if defined(BU6424AF)
	{OV8858_SENSOR_ID_TRULY, BU6424AF_LENS_ID, "BU6424AF", pBU6424AF_getDefaultData},
#endif

#if defined(FM50AF_OV8858)
	{OV8858_SENSOR_ID, FM50AF_LENS_ID, "FM50AF", pFM50AF_ov8858_getDefaultData},
#endif
...
#if defined(DW9718AF)
		{IMX111_SENSOR_ID, DW9718AF_LENS_ID, "DW9718AF", pDW9718AF_getDefaultData},
#endif

#if defined(VMC8178AF)
    {IMX134_SENSOR_ID, VMC8178AF_LENS_ID, "VMC8178AF", pVMC8178AF_getDefaultData},
#endif
