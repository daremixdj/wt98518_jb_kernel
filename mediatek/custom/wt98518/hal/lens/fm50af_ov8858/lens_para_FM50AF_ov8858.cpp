...
const NVRAM_LENS_PARA_STRUCT FM50AF_OV8858_LENS_PARA_DEFAULT_VALUE =
{
    //Version
    ...
    // AF NVRAM
    {
        ...
        {150, // i4Offset
          ...
          21, // i4MacroNum
           ...
           0, //i4MacroIdxOffset          
    	{
                 0,  10,  15,  20, 25, 35, 45, 60, 85, 95,
               105, 115, 135, 160, 190,  220,   260,   300,   340,   380,
...
// -------------------- sAF_TH ---------------------
        {
          ...
          {83, 89, 89, 82, 76, 67, 64, 60,
     122, 127, 127, 121, 116, 108, 105, 101,
...
// ------------------------------------------------------------------------
     ...
     6, 7, 6, 8, 9, 10, 11, 15,
     6, 7, 6, 8, 9, 10, 11, 15,
     6, 7, 6, 8, 9, 10, 11, 15}      // i4HW_TH2[GMEAN_MAX_NUM][ISO_MAX_NUM];       
...
// ------------------- sZSDAF_TH -----------------------------------
        {
           ...
           {88, 87, 87, 77, 69, 68, 67, 67,
     126, 125, 125, 117, 110, 109, 108, 108,
     180, 179, 179, 174, 170, 169, 169, 169},        // i4GMR[3][ISO_MAX_NUM];
...
// ------------------------------------------------------------------------
           ...
           {11, 13, 14, 17, 18, 20, 24, 39,
     11, 13, 14, 17, 18, 20, 24, 39,
     11, 13, 14, 17, 18, 20, 24, 39,
     11, 13, 14, 17, 18, 20, 24, 39,
     11, 13, 14, 17, 18, 20, 24, 39,
     11, 13, 14, 17, 18, 20, 24, 39}          // i4HW_TH2[GMEAN_MAX_NUM][ISO_MAX_NUM];       
// ------------------------------------------------------------------------           
        },
        1, // i4VAFC_FAIL_CNT;
...
UINT32 FM50AF_ov8858_getDefaultData(VOID *pDataBuf, UINT32 size)
{
    ...
    memcpy(pDataBuf, &FM50AF_OV8858_LENS_PARA_DEFAULT_VALUE, dataSize);

    return 0;
}

PFUNC_GETLENSDEFAULT pFM50AF_ov8858_getDefaultData = FM50AF_ov8858_getDefaultData;
