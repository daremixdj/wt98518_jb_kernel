...
MSDK_SENSOR_INIT_FUNCTION_STRUCT SensorList[] =
{
    ...
    RAW_INFO(OV8858_SENSOR_ID, SENSOR_DRVNAME_OV8858_MIPI_RAW,OV8858MIPIRAW_CAM_CALGetCalData),
#endif
#if defined(OV8858_MIPI_RAW_TRULY)
    RAW_INFO(OV8858_SENSOR_ID_TRULY, SENSOR_DRVNAME_OV8858_MIPI_RAW_TRULY,OV8858MIPIRAWTRULY_CAM_CALGetCalData),
#endif
