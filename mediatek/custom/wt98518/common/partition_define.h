...
#define PART_BLINKFEED "BLINKFEED" 
#define PART_ROOTM "ROOTM" 
...
#define PART_OFFSET_SEC_RO			(0x3da0000)
#define PART_SIZE_MISC			(512*KB)
#define PART_SIZE_LOGO			(8192*KB)
#define PART_SIZE_EBR2			(512*KB)
#define PART_SIZE_BLINKFEED			(26624*KB)
#define PART_SIZE_ROOTM			(4096*KB)
#define PART_SIZE_EXPDB			(13696*KB)
#define PART_SIZE_ANDROID			(1269760*KB)
#define PART_SIZE_CACHE			(212992*KB)
