...
ifeq ($(strip $(WT_MTK_DEFUALT_DAZHIHUI)),yes)
    PRODUCT_PACKAGES += Dazhihui
endif

ifeq ($(strip $(WT_MTK_DEFUALT_KAIXIN)),yes)
    PRODUCT_PACKAGES += Kaixin
endif

ifeq ($(strip $(WT_MTK_DEFUALT_QQGAME)),yes)
    PRODUCT_PACKAGES += QQGame
endif

ifeq ($(strip $(WT_MTK_DEFUALT_QQIM)),yes)
    PRODUCT_PACKAGES += QQIM
endif

ifeq ($(strip $(WT_MTK_DEFUALT_SOGOU)),yes)
    PRODUCT_PACKAGES += SogouInput
else ifeq ($(strip $(WT_CTA_SUPPORT)),yes)
	PRODUCT_PACKAGES += SogouInput
endif

ifeq ($(strip $(WT_MTK_DEFUALT_RENREN)),yes)
