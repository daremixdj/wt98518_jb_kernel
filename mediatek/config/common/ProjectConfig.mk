...
WT_INNER_VERSION = SW_PROJECT_V001_M10_CUSTOMER_6592
...
####factorymode control for HUAWEI####
MTK_HW_FACTORYMODE_SUPPORT = no
MTK_SINA_WEIBO_SUPPORT=no

####common macro for huawei project####	
WT_HUAWEI_PROJ = no
...
WT_RINGTONE_PICKER_SHOW_MORE_RINGTONES = no

WT_ILLEGAL_RINGTONES_PICKER = no


####ADD FOR OVERTURN SNOOZE and GSENSOR####
...
####animation roll for power off charging####
WT_ANIMATION_ROLL = yes
####animation roll for power off charging percent number####
...
### yjl add for uboot update when SD updating begin, default open
WT_UPDATE_UBOOT_IMG = yes
### yjl add for uboot update when SD updating end

WT_SDCARD_PLUGIN_OUT = no
WT_HUAWEI_MUSIC_SUPPORT = no
WT_ANDROID_MUSIC_SUPPORT = yes
# yubosong added for bug 248567 +
WT_FM_SUPPORT_CURSEARCH = no
# yubosong added for bug 248567 -
###add by guqinghuan config signal bar level
...
WT_HTC_WATERMARK = no
###add for wt customized audio sounds###
WT_CUSTOMIZED_AUDIO_SOUNDS = no
###add for wt common sign key###
...
WT_HTC_MOBILE_DATA_ON = yes
WT_HTC_NP_CODE_STYLE = no
