...
TEST_SRC_FILES := \
	...
	src/test/ftm_mhall.c \
	src/test/report_save.c \
	src/test/ftm_ps_cali.c	\
	src/test/ftm_version.c \
...
# sunxuewen added for htc_cid_seclect begin
$(warning   WT_HTC_CID $(WT_HTC_CID)   ) 
ifeq ($(WT_HTC_CID),yes)
LOCAL_CFLAGS += -DHTC_CID
endif
LOCAL_SRC_FILES += \
	src/cid/cid.c
# sunxuewen added end
...
LOCAL_C_INCLUDES:= \
	$(LOCAL_PATH)/inc/ \
	mediatek/custom/out/$(TARGET_PRODUCT)/factory/inc \
	...
	$(TARGET_PRODUCT)/cgen/cfgfileinc \
	$(TARGET_PRODUCT)/cgen/cfgdefault \
