...
// sunxuewen added for htc_cid begin
#define COLOR_GRAY      0XC0C0C0FF
#define COLOR_DFT_TEXT      0X7878FFA0
// sunxuewen added for htc_cid end
...
#define item(i, n) { .id = (i), .name = (n) , .background =0 , .itemtext =COLOR_DFT_TEXT, .mode =0}
// sunxuewen added for htc_cid begin
#define item_cid(i, n) { .id = (i), .name = (n) , .background =COLOR_GRAY , .itemtext =COLOR_BLACK, .mode =0}
// sunxuewen added for htc_cid end 
