...
int PhoneMic_Receiver_Loopback(char echoflag)
{
    if (echoflag == MIC1_ON)
    {
        android::LoopbackManager::GetInstance()->SetLoopbackOn(android::MD_MAIN_MIC_ACOUSTIC_LOOPBACK/*AP_MAIN_MIC_AFE_LOOPBACK*/, android::LOOPBACK_OUTPUT_RECEIVER);
    }
    else if (echoflag == MIC2_ON)
    {
        android::LoopbackManager::GetInstance()->SetLoopbackOn(android::MD_REF_MIC_ACOUSTIC_LOOPBACK/*AP_REF_MIC_AFE_LOOPBACK*/, android::LOOPBACK_OUTPUT_RECEIVER);
    }
    else
    {
...
int PhoneMic_EarphoneLR_Loopback(char echoflag)
{
    if (echoflag == MIC1_ON)
    {
        android::LoopbackManager::GetInstance()->SetLoopbackOn(android::MD_MAIN_MIC_ACOUSTIC_LOOPBACK/*AP_MAIN_MIC_AFE_LOOPBACK*/, android::LOOPBACK_OUTPUT_EARPHONE);
    }
    else if (echoflag == MIC2_ON)
    {
        android::LoopbackManager::GetInstance()->SetLoopbackOn(android::MD_REF_MIC_ACOUSTIC_LOOPBACK/*AP_REF_MIC_AFE_LOOPBACK*/, android::LOOPBACK_OUTPUT_EARPHONE);
    }
    else
    {
        android::LoopbackManager::GetInstance()->SetLoopbackOff();
...
int PhoneMic_SpkLR_Loopback(char echoflag)
{
    if (echoflag == MIC1_ON)
    {
        android::LoopbackManager::GetInstance()->SetLoopbackOn(android::MD_MAIN_MIC_ACOUSTIC_LOOPBACK, android::LOOPBACK_OUTPUT_SPEAKER);
    }
    else if (echoflag == MIC2_ON)
    {
        android::LoopbackManager::GetInstance()->SetLoopbackOn(android::MD_REF_MIC_ACOUSTIC_LOOPBACK, android::LOOPBACK_OUTPUT_SPEAKER);
    }
    else
    {
        android::LoopbackManager::GetInstance()->SetLoopbackOff();
...
int HeadsetMic_Receiver_Loopback(char bEnable, char bHeadsetMic)
{
    if (bEnable)
    {
        android::LoopbackManager::GetInstance()->SetLoopbackOn(android::MD_HEADSET_MIC_ACOUSTIC_LOOPBACK/*AP_HEADSET_MIC_AFE_LOOPBACK*/, android::LOOPBACK_OUTPUT_RECEIVER);
    }
    else
    {
        android::LoopbackManager::GetInstance()->SetLoopbackOff();
...
int HeadsetMic_EarphoneLR_Loopback(char bEnable, char bHeadsetMic)
{
    if (bEnable)
    {
        android::LoopbackManager::GetInstance()->SetLoopbackOn(android::MD_HEADSET_MIC_ACOUSTIC_LOOPBACK, android::LOOPBACK_OUTPUT_EARPHONE);
    }
    else
    {
        android::LoopbackManager::GetInstance()->SetLoopbackOff();
...
int HeadsetMic_SpkLR_Loopback(char echoflag)
{
    if (echoflag)
    {
        android::LoopbackManager::GetInstance()->SetLoopbackOn(android::MD_HEADSET_MIC_ACOUSTIC_LOOPBACK/*AP_HEADSET_MIC_AFE_LOOPBACK*/, android::LOOPBACK_OUTPUT_SPEAKER);
    }
    else
    {
        android::LoopbackManager::GetInstance()->SetLoopbackOff();
