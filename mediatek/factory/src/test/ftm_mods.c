...
extern int factory_reset_init(void);
extern int wt_version_init(void);
extern int tpOScircuit_init(void);
//extern int headset_debug_init(void);
extern int mhall_init(void);
