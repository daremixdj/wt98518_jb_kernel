...
>>>> ORIGINAL //ALPS_SW/DEV/ALPS.JB2.KERNEL34.DEV/alps/kernel/mm/memory.c#1

==== THEIRS //ALPS_SW/DEV/ALPS.JB2.KERNEL34.DEV/alps/kernel/mm/memory.c#2

	if (tlb->batch_count == MAX_GATHER_BATCH_COUNT)
		return 0;

==== YOURS //ws_wcpadmin_3010_bj/ALPS_SW/TRUNK/ALPS.JB2/alps/kernel/mm/memory.c
